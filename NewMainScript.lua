...
local function checkpublicrepo(id)
	local req = requestfunc({
		Url = "https://raw.githubusercontent.com/DoiGaMay/ppppp/main/CustomModules/"..id..".vape",
		Method = "GET"
	})
...
OnlineProfilesButton.MouseButton1Click:connect(function()
	...
	if profilesloaded == false then
		...
		local success, result = pcall(function()
			return game:GetService("HttpService"):JSONDecode((shared.VapeDeveloper and readfile("vape/OnlineProfiles.vapeonline") or game:HttpGet("https://raw.githubusercontent.com/DoiGaMay/ppppp/main/OnlineProfiles.vapeonline", true)))
		end)
